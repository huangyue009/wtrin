                    ...
                    <?php if(count($items) > 0):?>
                        <div class="col-md-6 billing">
                            ...
                            <div class="control-group span6">
                                ...
                                <div class="controls">
                                    <input name="first_name" type="text" value="" id="first_name" required>
                                </div>
                            </div>
                            <div class="control-group span6 last">
                				<label for="email" class="control-label"><?php echo $lumise->lang('Billing E-Mail'); ?></label>
                				<div class="controls">
                			...
                			<div class="control-group">
                				...
                				<div class="controls">
                                    <input name="address" placeholder="深圳市龙华区XXX路" type="text" value="" id="address" required>
                				</div>
                			</div>
                			<div class="control-group span6">
...
<!--                						<option value="VN">Vietnam</option>-->
                            ...
                            <div class="control-group last payments">
                                <h3><?php echo $lumise->lang('Payment'); ?></h3>
                				<div class="controls">
                                    <div class="lumise-payment-item">
                                        <input name="payment" type="radio" value="cod" id="payment-cod" checked="checked" required>
                        ...
                        <div class="col-md-6 order_overview">
                            <h3><?php echo $lumise->lang('Order Review'); ?></h3>
